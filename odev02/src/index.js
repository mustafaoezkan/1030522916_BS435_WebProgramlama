...
export const clickedImg0 = () => {
    ...
    if (indexArr[0] === 2 && isClicked < 3) {
        document.getElementById("img0").src = "cat.png";
        alert("Congrats! You found the cat!");
        refreshPage();
    } else if (indexArr[0] === 1 && isClicked < 3) {
        document.getElementById("img0").src = "dog.png";
    }
}

export const clickedImg1 = () => {
    if (indexArr[1] === 2 && isClicked < 3) {
        document.getElementById("img1").src = "cat.png";
        alert("Congrats! You found the cat!");
        refreshPage();
...
export const clickedImg2 = () => {
    if (indexArr[2] === 2 && isClicked < 3) {
        document.getElementById("img2").src = "cat.png";
        alert("Congrats! You found the cat!");
        refreshPage();
    } else if (indexArr[2] === 1 && isClicked < 3) {
        document.getElementById("img2").src = "dog.png";
    }
}
// check two press
const checkTwoPress = () => {
